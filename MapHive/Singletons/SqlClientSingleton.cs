    ...
    public class SqlClientSingleton : ISqlClientSingleton
    {
        ...
        private async Task ApplyEmptySchema(string dbFilePath)
        {
            ...
            try
            {
                ...
                // Insert initial version number
                _ = await InsertAsync(query: "INSERT INTO Configuration (Key, Value, Description) VALUES ('DevelopmentMode', '1', 'Set to 1 to enable development mode.');", parameters: null);
                LogBeforeDbCreated(logMessage: "Development mode (1) inserted.");
